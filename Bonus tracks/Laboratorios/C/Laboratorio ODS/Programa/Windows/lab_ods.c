...
void lista_de_paises(int y){
    switch(y){
        ...
        case 19: printf("Haiti"); break;
        case 20: printf("Honduras"); break;
        case 21: printf("Jamaica"); break;
        case 22: printf("Mexico"); break;
        case 23: printf("Nicaragua"); break;
        case 24: printf("Panama"); break;
        case 25: printf("Paraguay"); break;
        case 26: printf("Peru"); break;
        case 27: printf("Republica Dominicana"); break;
        case 28: printf("San Cristobal y Nieves"); break;
        case 29: printf("San Vicente y las Granadinas"); break;
        case 30: printf("Santa Lucia"); break;
...
void listar_todo(float matt[22][36]){
    for(y = 0; y <= 34; y++){
        for(x = 0; x <= 20; x++){
            printf("Anno >> %d | Pais >> ", 2000+x); lista_de_paises(y); printf(" | Emisiones de CO2 per capita (metrics tons per capita) >> %f\n", matt[x][y]);
        }
...
void listar_totales(float matt[22][36]){
    for(x = 0; x <= 20; x++){
        printf("Emisiones totales de CO2 en el anno %d >> %f\n", x+2000, matt[x][35]);
    }
...
void pais_menorymayor(float matt[22][36]){
    ...
    printf("El pais con menores emisiones de CO2 per capita (metrics tons per capita) es "); lista_de_paises(men); printf(" con >> %f\n", matt[21][men]);
    printf("El pais con mayores emisiones de CO2 per capita (metrics tons per capita) es "); lista_de_paises(may); printf(" con >> %f\n", matt[21][may]);
}


int ingresar_pais(void){

    printf("Indique el pais segun la denominacion a continuacion...\n");
...
void e_pais_user(float matt[22][36]){
    ...
    ingresar_pais();
    system("cls");
    printf("El numero de emisiones de "); lista_de_paises(pais_user-1); printf(" es >> %f\n", matt[21][pais_user-1]);
...
int ingresar_ann(void){
    ...
    printf("Indique el anno que desee evaluar desde el 2000 al 2020, ingresando el anno completo (4 digitos) \n");
...
void e_ann_user(float matt[22][36]){
    ...
    ingresar_ann();
    system("cls");
    printf("El numero de emisiones del anno %d es >> %f\n", ann_user, matt[ann_user-2000][35]);
}


void comp_paises(float matt[22][36]){
    printf("Ingrese dos paises que desee comparar.");
    ...
    system("cls");
    if(val1 > val2){
        lista_de_paises(comp1); printf(" posee un numero mayor de emisiones que "); lista_de_paises(comp2); printf(" con %f y %f, respectivamente.\n", val1, val2);
    } else
        if(val1 < val2){
            lista_de_paises(comp2); printf(" posee un numero mayor de emisiones que "); lista_de_paises(comp1); printf(" con %f y %f, respectivamente.\n", val2, val1);
        } else {
            printf("Ha ingresado el mismo pais. "); lista_de_paises(comp1); printf(" posee un numero de emisiones de "); printf("%f\n", val1);
        }
}
...
void comp_ann(float matt[22][36]){
    ...
    if(matt[comp1][35] > matt[comp2][35]){
        printf("En el anno %d hubo mayores emisiones de CO2 con respecto a %d con %f y %f, respectivamente.\n", comp1+2000, comp2+2000, matt[comp1][35], matt[comp2][35]);
    } else
        if(matt[comp1][35] < matt[comp2][35]){
            printf("En el anno %d hubo mayores emisiones de CO2 con respecto a %d con %f y %f, respectivamente.\n", comp2+2000, comp1+2000, matt[comp2][35], matt[comp1][35]);
        } else {
            printf("Se han seleccionado dos annos iguales. En el anno %d hubo %f emisones de CO2.\n", comp1+2000, matt[comp1][35]);
        }
}
...
char menu(void){
    ...
    printf("1- Listar todos los paises, por anno y con sus respectivos totales.\n");
    printf("2- Listar los totales, por pais y anno.\n");
    printf("3- Listar el pais con menor y mayor numero de emisiones en total.\n");
    printf("4- Ingresar un pais para conocer su numero total de emisiones.\n");
    printf("5- Ingresar un anno para conocer su numero total de emisiones.\n");
    printf("6- Ingresar dos paises para realizar una comparacion acerca de sus emisiones.\n");
    printf("7- Ingresar dos annos para realizar una comparacion acerca de sus emisiones.\n");
    printf("8- Detener la ejecucion del programa.\n");
    scanf("%s", &op);
...
char pregunta(void){
    printf("\nIngrese >> s << para realizar otra operacion.");
    printf("\nIngrese >> n << para detener la ejecucion del programa.\n");
    scanf("%s", &op);
    op = toupper(op);

    if(op != 'S' && op != 'N'){
        system("cls");
        printf("Ha ingresado un dato erroneo.");
        op = pregunta();
    }
    system("cls");
    return(op);
...
void inicio(void){
    ...
    printf("Ingrese >> n << para detener la ejecucion del programa.\n");
    scanf("%s", &op);
    op = toupper(op);

    if(op != 'S' && op != 'N'){
        system("cls");
        printf("\nHa ingresado un dato erroneo.\n");
        inicio();
    }
